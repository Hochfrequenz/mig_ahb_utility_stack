...
from maus.models.edifact_components import DataElement, DataElementFreeText, DataElementValuePool
...
class TestMaus:
    ...
    def test_ahb_flat_to_deep(self, sgh: SegmentGroupHierarchy, flat_ahb: FlatAnwendungshandbuch):
